...
var DateTimePicker = (function (_Component) {
  ...
  function DateTimePicker() {
    ...
    this.renderSwitchButton = function () {
      var viewDate = (0, _moment2["default"])(this.props.selectedDate, 'ddd MMM DD, YYYY', true).format('ddd MMM DD, YYYY');
      var viewTime = (0, _moment2["default"])(this.props.selectedDate, 'h:mm a', true).format('h:mm a');
      return _this.props.mode === _ConstantsJs2["default"].MODE_DATETIME ? _react2["default"].createElement(
        "li",
        null,
        _react2["default"].createElement(
          "button",
          { type: 'button', className: "btn btn-primary btn-sm picker-switch", style: { width: "100%" }, onClick: _this.props.togglePicker },
         _react2["default"].createElement("span", {}, _this.props.showTimePicker ? viewDate : viewTime)
        )
      ) : null;
    };
  }

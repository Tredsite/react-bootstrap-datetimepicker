    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          "div",
          { className: "input-group date " + this.size(), ref: "datetimepicker", style: {cursor: 'pointer'}, onBlur: this.onBlur, onClick: this.onClick },
          _react2["default"].createElement("input", _extends({ className: "form-control", onBlur: this.onBlur, onClick: this.onClick, onChange: this.onChange, type: "text", value: this.state.inputValue, style: {cursor: 'pointer'}}, this.props.inputProps)),
          _react2["default"].createElement(
            "span",
            { className: "input-group-addon", onBlur: this.onBlur, onClick: this.onClick, ref: "dtpbutton" },
            _react2["default"].createElement("span", {className: "glyphicon glyphicon-pro-" + this.state.buttonIcon, style: {marginTop:"-3px"}})
          )
        )
      );
    }
